export type ActivationPreview = {
  productId: "monitor" | "frame" | "crate" | "cue";
  name: "Monitor" | "Frame" | "Crate" | "Cue";
...
function isActivationPreview(value: unknown): value is ActivationPreview {
  ...
  return (preview.productId === "monitor" && preview.name === "Monitor" || preview.productId === "frame" && preview.name === "Frame" || preview.productId === "crate" && preview.name === "Crate" || preview.productId === "cue" && preview.name === "Cue")
